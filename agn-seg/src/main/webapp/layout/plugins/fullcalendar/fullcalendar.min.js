...
Ie=K.extend( {
    ...
    computeScrollBounds:function() {
        ...
        e&&(t=e.offset(), this.scrollBounds= {
            top: t.top, left: t.left, bottom: t.top+e.outerHeight(), right: t.left+e.outerWidth()
        }
        )
    }
    ,
...
Xe.mixin( {
    ...
    n) {
        ...
        return a.hasTime()===u.hasTime()?(i=E(u, a), r=n.start.clone().add(i), s=null===n.end?null: n.end.clone().add(i), o=n.allDay): (r=u.clone(), s=null, o=!u.hasTime()), l= {
            start: r, end: s, allDay: o
        }
        ,
        this.view.calendar.isEventRangeAllowed(l,
        n)?l:null
    }
    ,
    ...
    ,
    computeExternalDrop:function(t,
    e) {
        var n= {
        ...
        this.view.calendar.isExternalDropRangeAllowed(n,
        e.eventProps)?n:null
    }
    ,
    renderDrag:function() {},
    destroyDrag:function() {},
    segResizeMousedown:function(t,
    e) {
        function n() {
...
$e.mixin( {
    ...
    renderBgSegs:function(e) {
        ...
        return Xe.prototype.renderBgSegs.call(this,
        n)
    }
    ,
...
$e.mixin( {
    ...
    n) {
        ...
        return t('<a class="fc-more"/>').text(this.getMoreLinkText(n.length)).on("click", function(s) {
            ...
            ,
            s)),
            "popover"===o?i.showSegPopover(e,
            a,
            c):"string"==typeof o&&r.calendar.zoomTo(l,
            o)
        }
        )
    }
    ,
    showSegPopover:function(t,
    e,
    n) {
    ...
    ,
    renderSegPopoverContent:function(e,
    n) {
...
var qe=De.View=K.extend( {
    ...
    ,
    eventSegEach:function(t,
    e) {
        var n, i=this.getEventSegs();
        for(n=0;
        i.length>n;
        n++)e&&i[n].event._id!==e._id||t.call(this, i[n])
    }
    ,
    getEventSegs:function() {
        return[]
    ...
    ,
    triggerExternalDrop:function(t,
    e,
    n,
    i,
    r) {
