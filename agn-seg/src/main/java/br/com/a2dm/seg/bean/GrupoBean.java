...
import br.com.a2dm.cmn.entity.Grupo;
import br.com.a2dm.cmn.entity.GrupoTelaAcao;
import br.com.a2dm.cmn.entity.Sistema;
import br.com.a2dm.cmn.entity.TelaAcao;
import br.com.a2dm.cmn.service.GrupoService;
import br.com.a2dm.cmn.service.GrupoTelaAcaoService;
import br.com.a2dm.cmn.service.SistemaService;
import br.com.a2dm.cmn.service.TelaAcaoService;
...
public class GrupoBean extends AbstractBean<Grupo, GrupoService>
{
	...
	protected boolean validarAcesso(String acao)
	{
		...
		if (!ValidaPermissao.getInstancia().verificaPermissao("grupo", acao))
		{
			...
			try
			{
				rp.sendRedirect("/agn-seg/pages/acessoNegado.jsf");
			}
			catch (IOException e)
			{
				e.printStackTrace();
